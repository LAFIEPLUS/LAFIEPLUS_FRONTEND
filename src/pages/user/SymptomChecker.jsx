...
import { Activity, Plus, X, AlertTriangle, CheckCircle, ArrowRight, Building2, MessageSquare } from 'lucide-react';
...
const commonSymptoms = [
  ...
  'Diarrhoea', 'Chest pain', 'Shortness of breath', 'Abdominal pain',
  'Back pain', 'Dizziness', 'Rash', 'Sore throat', 'Loss of appetite'
];
...
export default function SymptomChecker() {
  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      // Controller returns flat data at res.data.data level
          ...
          <Card className={styles.resultCard}>
            ...
            <div className={styles.resultBody}>
              ...
              <div className={styles.symptomsChecked}>
                ...
                <div className={styles.tags}>
                  {symptoms.map(s => (
                    <span key={s} className={styles.tagChecked}>{s}</span>
                  ))}
                </div>
              </div>
              ...
              {result.recommendConsultation && !result.seekCareImmediately && (
                <div className={styles.consultAlert}>
                  <MessageSquare size={16} />
                  Based on your symptoms, speaking with a health partner is recommended.
                </div>
              )}
              ...
              <div className={styles.resultActions}>
                ...
                <Link to="/facilities">
                  <Button variant="green">
                    <Building2 size={16} /> Find Facility <ArrowRight size={14} />
                  </Button>
                </Link>
                <Link to="/consultations">
                  <Button>
                    <MessageSquare size={16} /> Talk to Partner <ArrowRight size={14} />
                  </Button>
                </Link>
              </div>
            </div>
